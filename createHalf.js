...
function createHalf(){
    ...
    stats[14] = 0;
    getFate();
    career = chooseHalfCar();
    skills[0] = "Academic Knowledge(Geneaology)";
    skills[1] = "Academic Knowledge(Heraldry)";
    skills[2] = "Common Knowledge(Halflings)";
    skills[3] = "Speak Language(Halfling)";
    skills[4] = "Speak Language(Reikspiel)";
    skills[5] = "Trade(Cook)";
    skills[6] = "Trade(Farmer)";
    talents[0] = randTalents();
    talents[1] = "Night Vision";
    talents[2] = "Resistance to Chaos";
    talents[3] = "Specialist Weapon Group(Sling)";
