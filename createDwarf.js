...
function createDwa(){
    ...
    stats[14] = 0;
    getFate();
    career = chooseDwaCar();//fix dice
    skills[0] = "Common Knowledge(Dwarfs)";
    skills[1] = "Gossip";
    skills[2] = "Speak Language(Reikspiel)";
    skills[3] = "Speak Language(Khazalid)";
    skills[4] = "Trade(Stoneworker)";
    skills[5] = "Trade(Smith)";
    skills[6] = "Trade(Miner)";
    talents[0] = "Dwarfcraft";
    talents[1] = "Grudge-born Fury";
    talents[2] = "Night Vision";
    talents[3] = "Resistance to Magic";
    talents[4] = "Stout-hearted";
    talents[5] = "Sturdy";
